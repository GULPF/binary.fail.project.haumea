...
{
    public class DebugTextView : IView
    {
        ...
        public DebugTextView(Provinces provinces, Units units, 
        ...
        {
            _debugFont = content.Load<SpriteFont>("LogFont"); 
        }
        ...
        private void Log(string msg, Vector2 screenDim, SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.DrawString(_debugFont, msg, p0, Color.White);
        }
